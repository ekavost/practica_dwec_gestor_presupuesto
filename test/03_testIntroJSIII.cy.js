...
describe("Función filtrarGastos", function () {
  it("Filtra los gastos (variable global 'gastos') de acuerdo con los parámetros pasados a la función", function () {
    ...
    assert.lengthOf(
      filtrarGastos({ descripcionContiene: "Seguro", valorMinimo: 10, valorMaximo: 200 }),
      1,
    ...
    assert.lengthOf(
      filtrarGastos({ etiquetasTiene: ["transporte", "comida"], fechaHasta: "2020-12-31", valorMaximo: 200 }),
      1,
